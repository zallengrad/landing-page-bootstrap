             ...
             <div class="text-center mb-3">
              ...
              <div class="text-center">
                  <div class="d-flex justify-content-center gap-3 mb-3">
                    <a href="login-adm.php" style="text-decoration: none;" class="btn btn-primary btn-lg">As Admin</a>
                    <a href="login-user.php" style="text-decoration: none;" class="btn btn-primary btn-lg">As User</a>
                  </div>
               ...
               <!-- Sign Up -->
                <div class="text-center">
                  <small>Belum Punya Akun Masuk? <a href="../signup/prasignup.php" class="fw-bold"> Sign Up</a></small>
                </div>
