    ...
    <section id="product" class="container mt-5">
      <div class="row col-12">
        <div class="col-12 pb-4">
          <h2 class="display-4 text-center mb-1" style="margin-top: 5px">Daftar Kelas Terbaru</h2>
        </div>
      ...
      <p class="lead pb-3">Kirim pesan untuk ambil Kelas kami.</p>
      <a href="https://wa.me/+6285641821400" class="btn button-primer btn-lg mb-4">Whatsapp Kami</a>
    </section>
