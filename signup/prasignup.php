...
if (isset($_POST["register"])) {
  ...
  if($db->query($sql)) {
    $success = "Anda berhasil mendaftar!";
  } else {
              ...
              <!-- Form -->
                <div class="text-center">
                  <div class="d-flex justify-content-center gap-3 mb-3">
                    <a href="signup-adm.php" style="text-decoration: none;" class="btn btn-primary btn-lg">As Admin</a>
                    <a href="signup-user.php" style="text-decoration: none;" class="btn btn-primary btn-lg">As User</a>
                  </div>
                  <p class="text-white-50 text-decoration-underline">Try it first</p>
                </div>

               <!-- Sign Up -->
                <div class="text-center">
                  <small>Sudah Punya Akun Masuk? <a href="../login/pralogin.php" class="fw-bold">Log In</a></small>
                </div>
